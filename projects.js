...
const PROJECTS = [
...

  {
    id: 'ue5-soullike',
    name: 'UE5 SoulLike',
    subtitle: 'Networked Action RPG Modernization',
    concept: '2년 전 UE 액션 RPG 코드를 멀티플레이 동기화, Steam OSS, 통합 액션 레이어 관점에서 현대화한 프로젝트입니다.',
    description: 'UE5_SoulLike는 기존 액션 RPG 프로젝트에 투입되어 코드 구조, 네트워크 동기화, AI 액션 흐름을 다시 진단하고 개선하는 현대화 프로젝트입니다.\n\n문서에서는 Steam Online Subsystem 전환보다 먼저 NULL OSS 기반 반복 테스트 기준을 세우고, 플레이어 액션, 피격, 스킬, AI 타이밍 공격의 서버 권한과 클라이언트 표현 책임을 분리하는 방향을 정리했습니다. 소스에는 GameplayAbilities, GameplayTags, OnlineSubsystemSteam, Enhanced Input, AI/UMG 모듈 의존성이 확인됩니다.\n\n최근 작업 로그 기준으로 사망/부활 책임 분리, 플레이어별 리스폰 타이머, 부착 액터 visibility 복구, 콤보 플래그 초기화, Grux 메테오 폭발 판정/이펙트 보정 등을 수행했고 UnrealBuildTool 빌드 성공 결과를 기록했습니다.',
    category: 'Unreal / Multiplayer',
    role: 'Gameplay / Network Modernization',
    period: '2024.07 ~ 2024.08 ( 약 1달 ) ',
    tech: 'UE5.7, C++, Gameplay Tags, Gameplay Abilities, OnlineSubsystemSteam, AI, UMG',
    thumbnail: 'assets/projects/ue5-soullike/thumbnail.png',
    video: '',
    docs: 'assets/projects/ue5-soullike/docs/SoulLike_ServerAuthority_Technical_Document.html',
    devlog: 'https://github.com/ooweaJ/UE5_SoulLike/tree/main/docs/work-log',
    github: 'https://github.com/ooweaJ/UE5_SoulLike',
    featured: false,
    hasAward: false,
    award: '',
    hasHost: false,
