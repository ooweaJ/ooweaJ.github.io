...
<img width="742" height="488" alt="InputAction" src="https://github.com/user-attachments/assets/3b188a05-270c-4e3a-bfb3-572b41e088fb" />
Player 게임 오브젝트에 `Player Input` 컴포넌트를 추가한 후 Behavior를 `Invoke Unity Events`로 설정 한다.
그리고 이벤트 부분에 콜백함수를 바인딩 하여 실행시켜보았다.
<img width="371" height="297" alt="PlayerInput함수바인딩" src="https://github.com/user-attachments/assets/a6f6a61c-734d-47c3-a676-4afe8d8feeac" />
...
<img width="369" height="438" alt="애니메이션끝까지" src="https://github.com/user-attachments/assets/d5d3508a-6fd1-4502-83ee-fd4108ba1054" />
